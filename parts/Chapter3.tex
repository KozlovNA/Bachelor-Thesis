    \section{{\color{red}Улучшения} блочного метода стабилизированных бисопряженных градиентов}
...
\end{algorithm}
\subsection{Проблемы}
\par В данном алгоритме возможны брейкдауны, в случаях, когда матрица $\tilde{R}_0^*AP_k$ становится
